...
var doubleCheck=(arr)=>{
  // let checker=false;
  // groceries.forEach((val)=>{val==="chocolate"?checker=true:checker=false});
  // if(checker){
...
//   arr.map((val)=>{
//     console.log(val);
//     val>=100||val%2!=0?mySum+=val:console.log("Nope");
//   })
// }
///Why did this not work? I know that .map returns a new array but I also tried forEach and Reduce but 
///could not figure out how to make those work either.
///I probably should have tried filter and then added the results from that to mySum
var looper=(arr)=>{
  var mySum=0
  for(var i in arr){
